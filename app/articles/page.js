		...
		<main className="container mx-auto p-2 mt-[80px] max-w-[60rem]">
				...
				>
					...
					<div className="flex flex-col md:flex-row">
						...
						<div className="flex flex-col flex-grow p-4 bg-gray-50">
							...
							<p className="mt-1 text-lg font-medium text-gray-700">{post.subtitle}</p>
			...
			<div className="flex justify-center items-center mt-8 space-x-2">
				...
				<Link
					...
					className={`px-4 py-2 rounded ${
						page < totalPages ? "hover:underline" : "cursor-not-allowed text-white"
					}`}
